	...
	<div class="wrapper">
		...
		<div class="container content">
			...
			<c:forEach items="${list}" var="group">
						...
						<div class="pricing hover-effect" style="float: left; margin-left: 20px;">
							...
							<ul class="pricing-content list-unstyled">
								<li> <img src="/displayFile?fileName=${group.gr_icon}"  /></li>
			...
			<form action="create_gr" method="get" >
					<button type="submit" style="background-color:yellow; width:100px; height:100px; font-size:50px;margin-left: 80%;">+</button>
				</form>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							<a href="main" style="text-align: right;"><img id="logo-footer" class="footer-logo" src="./resources/img/logo(w).png" alt=""></a>
