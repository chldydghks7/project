	...
	<div class="wrapper">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown active"><a href="javascript:void(0);"
							...
							<ul class="dropdown-menu">
								...
								<li class="dropdown-submenu"><a href="racePoint">RacePoint</a>
								</li>
								<!-- End Service Pages -->
							</ul></li>
						<!-- End Pages -->
		...
		<div class="container content">
			...
			<form id="registerForm" action="create_gr" method="post">
				...
				<input type="hidden" id="gr_leader" name="gr_leader" value="${uid}">
				<br> <input type="hidden" id="uid" name="uid" value="${uid}">
				<br> <input type="hidden" name="introduce" value="그룹장">
				<br>
				<div class="form-group">
					그룹이름 : <input type="text" id="gr_name" name="gr_name"> <input
						type="button" id="n_check" value="중복체크"> <br>
				</div>
				<div class="form-group">
					그룹소개 :
					<textarea id="gr_content" name="gr_content"></textarea>
				</div>
				<!-- 파일 업로드 -->
				<div>
